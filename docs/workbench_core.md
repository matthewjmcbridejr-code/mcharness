...
Captain Mode state machines can be created from workbench threads and then advanced through plan, queue, assign-minions, and continue calls without ever launching real execution.
...
- Continuation is blocked when proof gates are open and safe-noop or ready-to-continue after approval.
